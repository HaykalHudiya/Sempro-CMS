<x-layout>
                            ...
                            <div class="card-contents">
                                <div class='cards'>
                                    <div class='card-infos'>
                                        <h3 class='text-start'>UNCAL ESB Key Features</h3>
                                        <p class='text-start'>Many companies are looking for system to optimize their existing business processes, it has become an increasing challenge for company. UNCAL Digital Technology proudly presents</p>
                                        <a href='Articles/Article1.html' target='_blank'>Read More <i class='bi bi-arrow-right-circle-fill'></i></a>
                                    </div>
                                </div>
                                <div class='cards'>
                                    <div class='card-infos'>
                                        <h3 class='text-start'>Why we should use system integration?</h3>
                                        <p class='text-start'>In this generation with the rapidly changing responsibilities and technology, and business wants to lead the industry, they need all their systems to work synchronously. However, System Integration is one of the best solutions</p>
                                        <a href='Articles/Article2.html' target='_blank'>Read More <i class='bi bi-arrow-right-circle-fill'></i></a>
                                    </div>
                                </div>
                                <div class='cards'>
                                    <div class='card-infos'>
                                        <h3 class='text-start'>Business Intelligence</h3>
                                        <p class='text-start'>In this globalization era, information is become an important component in daily life. Moreover, we have been facilitated by technological advances that make information very easy to obtain on various platforms</p>
                                        <a href='Articles/Article3.html' target='_blank'>Read More <i class='bi bi-arrow-right-circle-fill'></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 d-flex justify-content-end">
                                <button onclick="location.href='/resource/articles'" class="btn btn-primary btn-lg rounded-pill" type="button" style="text-transform: capitalize;">More Articles</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid" style="background-color: #E6EAEE;" id="whitepapers">
        <section class="page-section">
            <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-3 d-flex align-items-center mx-3"  style="height: 450px;" id="rounded" data-aos="fade-up"
                        data-aos-delay="200">
                        <ul style="list-style: none; padding-left: 1rem;">
                            <li style="font-size: 21px;height: 100px;margin-top: 1rem;" id="popsb">Implementation of UNCAL ESB in<br>Logistic System
                            </li>
                            <li>
                                <p style="height: 230px;margin-top: 1rem;" id="popr">
                                    Nowadays, we must be familiar with the word logistic. According to Oxford
                                    Dictionary, Logistics is the process of planning and organizing to make sure that
                                    resources are in the places where they are needed
                                </p>
                            </li>
                            <li class="d-flex justify-content-center"><button type="button"
                                    onclick="location.href='Whitepapers/WP1.html'" class="btn btn-lg rounded-pill"
                    ...
                    <div class="col-lg-3 d-flex align-items-center mx-3" style="height: 450px;" id="rounded" data-aos="fade-up"
                        data-aos-delay="400">
                        <ul style="list-style: none; padding-left: 1rem;">
                            <li style="font-size: 19px;height: 100px;margin-top: 1rem;" id="popsb">UMC accelerate and streamline RDN<br>reconciliation
                    ...
                    <div class="col-lg-3 d-flex align-items-center mx-3" style="height: 450px;" id="rounded" data-aos="fade-up"
                        data-aos-delay="600">
                        <ul style="list-style: none; padding-left: 1rem;">
                            <li style="font-size: 21px;height: 100px;margin-top: 1rem;" id="popsb">Why use an Enterprise Service Bus?</li>
                            <li>
                                <p style="height: 230px;margin-top: 1rem;" id="popr">
                    ...
                    <div class="col-12 mt-3 d-flex justify-content-end">
                        <button onclick="location.href='/resource/whitepapers'" class="btn btn-lg rounded-pill" type="button" style="text-transform: capitalize;background-color: #DC9750;color: white;">More Articles</button>
                    </div>
                </div>
            </div>
        </section>
                ...
                <swiper-container class="mySwiper"
                    ...
                    <swiper-slide>
                        <div class="d-flex text-center mb-5 align-items-center" id="corners3">
                            <ul style="padding-left: 0;list-style: none;">
                                <li><img src="{{ asset('Assets/Website/media/R&E/Webinar/IMG-20200813-WA0007 1.png') }}" alt=""></li>
                                <li style="font-size: 21px;" id="popsb">WEBINAR Making INDONESIA 4.0 : Independent in
                                    Information Technology</li>
                                <li>
                                    <p style="font-size: 16px;margin-top: 1rem;" id="popm">Event date : August 24,2020
                                        14:00 - 15:30</p>
                                </li>
                                <li>
                                ...
                                <li><a href="https://youtu.be/NNRpthsHj4E?si=Uybw-kHBK4ItH7sk" target="_blank">Watch Now
                    ...
                    <swiper-slide>
                        <div class="d-flex text-center align-items-center" id="corners3">
                            <ul style="padding-left: 0;list-style: none;">
                                <li><img src="{{ asset('Assets/Website/media/R&E/Webinar/Making Indonesia 4 1.png') }}" alt=""></li>
                                <li style="font-size: 21px;" id="popsb">WEBINAR Making INDONESIA 4.0 : INTEGRATED
                                    LOGISTIC IN INDUSTRY 4.0</li>
                                <li>
                                    <p style="font-size: 16px;margin-top: 1rem;" id="popm">Event date : September 8th,
                                        2021 14:00 - 15:30</p>
                                </li>
                                <li>
                                ...
                                <li><a href="https://youtu.be/709tQYhdBjE?si=3I9iJMAUsiRKlW02" target="_blank">Watch Now
                                        <i class="bi bi-arrow-right-circle-fill"></i></a></li>
                            </ul>
                        </div>
                    </swiper-slide>
                    <swiper-slide>
                        <div class="d-flex text-center align-items-center" id="corners3">
                            <ul style="padding-left: 0;list-style: none;">
                                <li><img src="{{ asset('Assets/Website/media/R&E/Webinar/WhatsApp Image 2021-12-06 at 6.11 1.png') }}" alt="">
                                </li>
                                <li style="font-size: 21px;" id="popsb">PARTNER WEBINAR: Integration platform for your
                                    digital transformation for indonesia 4.0</li>
                                <li>
                                    <p style="font-size: 16px;margin-top: 1rem;" id="popm">Event date : December 9th,
                                        2021 14:00 - end</p>
                                </li>
                                <li>
                                ...
                                <li><a href="https://www.linkedin.com/posts/uncal-digital-technology_business-technology-digital-activity-6874240285971410944-t86g?utm_source=share&utm_medium=member_desktop"
                                        target="_blank">Watch Now <i class="bi bi-arrow-right-circle-fill"></i></a></li>
                            </ul>
                        </div>
                    </swiper-slide>
                    <swiper-slide>
                        <div class="d-flex text-center align-items-center" id="corners3">
                            <ul style="padding-left: 0;list-style: none;">
                                <li><img src="{{ asset('Assets/Website/media/R&E/Webinar/169189289_591775761755416_4847455773890772819_n 1.png') }}"
                                        alt=""></li>
                                <li style="font-size: 21px;" id="popsb">Hannover Messe 2021 "Technological Advances For
                                    Industrial Transformation 4.0" Pre-conference</li>
                                <li>
                                    <p style="font-size: 16px;margin-top: 1rem;" id="popm">Event date : April 15th, 2021
                                        14:00 - end</p>
                                </li>
                                <li>
    ...
    <div class="container text-center">
        ...
        style="--swiper-navigation-size: 25px; --swiper-navigation-sides-offset: 10px; --swiper-pagination-color: var(--swiper-theme-color)"
        pagination="true" pagination-clickable="true" navigation="false" space-between="20" speed="1000"
        slides-per-view="1" slides-per-group="1" autoplay-delay="4500"
        autoplay-disable-on-interaction="false" loop="true" centered-slides="true" >
        <swiper-slide>
            <div class="col-12 mb-5" id="corners4">
                <ul style="padding-left: 0;list-style: none;margin-top: 5rem;">
                    <li><img src="{{ asset('Assets/Website/media/R&E/Event/UNCAL HANNOVER MESSE 4 1.png') }}" alt=""></li>
        ...
        <swiper-slide>
            <div class="col-12 d-flex text-center align-items-center" id="corners4">
                <ul style="padding-left: 0;list-style: none;">
                    <li><img src="{{ asset('Assets/Website/media/R&E/Event/IMG_1833 1.png') }}" alt=""></li>

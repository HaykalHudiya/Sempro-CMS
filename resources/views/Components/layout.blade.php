    ...
    <footer class="d-flex bg-dark text-light flex-wrap justify-content-between align-items-center py-3 mt-4">
        <div class="col-md-4 mb-0 d-flex align-items-center" style="margin-right: 3rem;">
            <div class="col-1 d-inline-flex d-flex align-items-center ms-3"><img
                    src="{{ asset('Assets/Website/media/UNCAL BARU 8 (LOGO).PNG') }}" alt=""
        ...
        <ul class="list-unstyled d-flex ms-auto p-2 me-3">
            <li class="ms-3"><a class="btn text-light btn-lg btn-floating"
                    href="https://www.instagram.com/uncaldt/" role="button" style="background-color: #DC9750;"><i
                        class="fab fa-instagram fa-2x"></i></a></li>
            <li class="ms-3"><a class="btn text-light btn-lg btn-floating" href="https://twitter.com/UncalDt"
                    role="button" style="background-color: #DC9750;"><i class="fab fa-twitter fa-2x"></i></a></li>
            <li class="ms-3"><a class="btn text-light btn-lg btn-floating"
                    href="https://www.linkedin.com/company/uncal-digital-technology/" role="button"
                    style="background-color: #DC9750;"><i class="fab fa-linkedin-in fa-2x"></i></a></li>
            <li class="ms-3"><a class="btn text-light btn-lg btn-floating"
                    href="https://www.youtube.com/channel/UCFNlKyy25thdco-xCOeCEiA" role="button"
                    style="background-color: #DC9750;"><i class="fab fa-youtube fa-2x"></i></a></li>
        </ul>
    </footer>

                ...
                <div class="col-md-4 stretch-card grid-margin">
                    <div class="card bg-gradient-danger card-img-holder text-white">
                        <div class="card-body">
                            ...
                            <h2 class="mb-5">{{ count($visitors) }}</h2>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 stretch-card grid-margin">
                ...
                <div class="card-body">
                  ...
                  <div class="row mt-3">
                    <div class="col-6 pe-1">
                      <img src="{{ asset('Assets/CMS/images/dashboard/img_1.jpg') }}" class="mb-2 mw-100 w-100 rounded" alt="image">
                      <img src="{{ asset('Assets/CMS/images/dashboard/img_4.jpg') }}" class="mw-100 w-100 rounded" alt="image">
                    </div>
                    <div class="col-6 ps-1">
                      <img src="{{ asset('Assets/CMS/images/dashboard/img_2.jpg') }}" class="mb-2 mw-100 w-100 rounded" alt="image">
                      <img src="{{ asset('Assets/CMS/images/dashboard/img_3.jpg') }}" class="mw-100 w-100 rounded" alt="image">
                    </div>
                  </div>
                  <div class="d-flex mt-5 align-items-top">
                    <img src="{{ asset('Assets/CMS/images/faces/face3.jpg') }}" class="img-sm rounded-circle me-3" alt="image">
